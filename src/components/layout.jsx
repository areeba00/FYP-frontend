      ...
      <header class=" relative bg-white mx-auto px-4 sm:px-6 sticky top-0">
        <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <nav class="hidden md:flex space-x-10">
            <Link to="/" class="text-base font-medium text-gray-500 hover:text-gray-900"> Candidates</Link>
            <Link to="/company" class="text-base font-medium text-gray-500 hover:text-gray-900"> Employers</Link>
            <Link to="/" class="text-base font-medium text-gray-500 hover:text-gray-900"> Profiles</Link>
            <Link to="/student" class="text-base font-medium text-gray-500 hover:text-gray-900"> Students</Link>
          </nav>

          <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a href="#" class="whitespace-nowrap text-base font-medium text-indigo-600 hover:text-indigo-700"> Sign in </a>
