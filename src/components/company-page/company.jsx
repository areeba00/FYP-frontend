                    ...
                    <div class="flex justify-between items-center border-b-2 border-gray-200 py-6 md:justify-start md:space-x-10">
                        ...
                        <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                            <div class="row-2 md:row-2">
                                ...
                                <div class="text-center text-base font-medium text-indigo-700"> Systems Limited </div>
                            </div>
                        </div>
                    </div>
                </header>
                    ...
                    <div class="overflow-y-auto py-4 px-3 bg-slate-200 rounded">
                        <ul class="space-y-4">
                            <div class="row-2 md:row-2 pt-8 pb-6">
                                ...
                                <div class="text-center text-base font-medium text-indigo-700 pt-4"> Systems Limited </div>
                            </div>
                            <li>
                                <Link class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-indigo-300 " to="/company">
                                    <i className="pi pi-home"></i>
                                    <span class="ml-3">Dashboard</span>
                                </Link>
                            </li>
                            <li>
                                <Link class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-indigo-300 " to="/company/jobposting">
                                    <i className="pi pi-list"></i>
                                    <span class="ml-3">Job Postings</span>
                                </Link>
                            </li>
                            <li>
                                <Link class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-indigo-300 " to="/company/post">
                                    <i className="pi pi-plus"></i>
                                    <span class="ml-3">Post new Job</span>
                                </Link>
                            </li>
                            <li>
                                <Link class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-indigo-300 " to="/company/dashboard">
                                    <i className="pi pi-envelope"></i>
                                    <span class="ml-3">Messages</span>
                                </Link>
                            </li>
                            <li>
                                <Link class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-indigo-300 " to="/company/shortlisted">
                                    <i className="pi pi-users"></i>
                                    <span class="ml-3">Shortlisted Candidates</span>
                                </Link>
                            </li>
                            <li>
                                <Link class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-indigo-300 " to="/company/profile">
                                    <i className="pi pi-user-edit"></i>
                                    <span class="ml-3">Edit Company Details</span>
                                </Link>
                            </li>
                        </ul>
                    </div>
