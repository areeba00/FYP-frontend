        ...
        <div class="flex flex-row min-h-screen bg-gray-100 text-gray-800">
            <div class="overflow-y-auto py-4 px-3 bg-slate-200 rounded">
                <ul class="space-y-4">
                    ...
                    <li>
                        <Link class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-indigo-300 " to="/student">
                            <i className="pi pi-home"></i>
                            <span class="ml-3">Dashboard</span>
                        </Link>
                    </li>
                    <li>
                        <Link class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-indigo-300 " to="/student/search">
                            <i className="pi pi-list"></i>
                            <span class="ml-3">Search Jobs</span>
                        </Link>
                    </li>
                    <li>
                        <Link class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-indigo-300 " to="/student/body">
                            <i className="pi pi-plus"></i>
                            <span class="ml-3">Create CV</span>
                        </Link>
                    </li>
                    <li>
                        <Link class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-indigo-300 " to="/student/messages">
                            <i className="pi pi-envelope"></i>
                            <span class="ml-3">Messages</span>
                        </Link>
                    </li>
                    <li>
                        <Link class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-indigo-300 " to="/student/profile">
                            <i className="pi pi-users"></i>
                            <span class="ml-3">Profile</span>
                        </Link>
                    </li>
                    <li>
                        <Link class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-indigo-300 " to="/student/edit">
                            <i className="pi pi-user-edit"></i>
                            <span class="ml-3">Edit Your Profile</span>
                        </Link>

                        <Link class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-indigo-300 " to="/student/job/:jobId">
                        <i className="pi pi-user-edit"></i>
